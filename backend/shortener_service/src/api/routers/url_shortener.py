...
from src.core.url_shortener import create_short_url_core
...
async def redirect_long_url(
    ...
    long_url = await url_repository.get_long_url(short_code)
    ...
    return RedirectResponse(url=long_url.long_url)
